...
def multi_game(difficulty, lolly, bestie, power_ups):
    ...
    while carryOn:
            ...
            for car_1 in left_incoming_cars:
                ...
                if pygame.sprite.collide_rect(LollyCar, car_1):
                    ...
                    # if they don't, check if they have HP to survive the crash
                        ...
                        if BestieCar.health == 0:
                            game_over(difficulty, LollyCar, BestieCar, power_ups)
        ...
        if toy_transforminator_active:
            ...
            if pygame.sprite.collide_rect(LollyCar, toy_transforminator):
                LollyCar.resize(0.95, 0.95)

            if pygame.sprite.collide_rect(BestieCar, toy_transforminator):
